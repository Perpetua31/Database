...
--authorized-networks 172.56.161.0/24 \ 
--storage-type SSD \
--storage-size 10GB \
--tier=db-n1-standard-1 \
--region=us-east1

\connect --mysql --user root --host 35.231.84.103 --ssl-ca=server-ca.pem --ssl-cert=client-cert.pem --ssl-key=client-key.pem --password
...
CREATE USER 'musicadmin'@'%' IDENTIFIED BY 'mypassword';  
...
\q
\mysqlsh
\connect musicadmin@35.231.84.103
